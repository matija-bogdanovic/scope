...
function page() {
  ...
  return (
      ...
      <div className='overflow-hidden'>
        <div className='container relative m-auto'>
          <div className='flex xsm:flex-col lg:flex-row justify-between relative'>
            <div>
              <h1 className='text-white text-3xl font-bold'>Argyle House | King's Cross</h1>
            </div>
            <div>
              <span className='text-white text-sm'>29-31 Euston Road | London | NW1 2SD</span>
            </div>
          </div>
          <div className='py-14'>
            <Carousel
            ...
            >
              <Image width={554} height={408} className='w-full pr-6' src={thirtyone} alt={thirtyone}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtytwo} alt={thirtytwo}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtythree} alt={thirtythree}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtyfour} alt={thirtyfour}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtyfive} alt={thirtyfive}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtysix} alt={thirtysix}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtyseven} alt={thirtyseven}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtyeight} alt={thirtyeight}/>
              <Image width={554} height={408} className='w-full pr-6' src={thirtynine} alt={thirtynine}/>
              <Image width={554} height={408} className='w-full pr-6' src={forty} alt={forty}/>
            </Carousel>
          </div>
        </div>
      </div>
    ...
    <section className="lg:py-20 xsm:py-10 font-['Aventa']">
      <div className='container'>
        <h1 className='font-bold text-3xl mb-4'>Argyle House | King's Cross</h1>
        <p className='text-graytext'>Home to big tech and with Camden Town and Euston nearby, a meeting room in King’s Cross is convenient for clients and colleagues to commute and attend meetings with ample entertainment opportunities in the vicinity too. King's Cross, the most centrally located area in London and the UK, offers international connectivity to Europe. Our workspace solutions are designed to accommodate businesses of all sizes, from small startups to large enterprises.</p>
      </div>
    </section>
    <section className="lg:py-20 xsm:py-10 font-['Aventa']">
      <div className='container'>
