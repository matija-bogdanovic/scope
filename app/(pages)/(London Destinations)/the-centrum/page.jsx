      ...
      <section className="lg:py-20 xsm:py-10 font-['Aventa']">
        <div className="container">
          <h1 className="font-bold text-3xl mb-4">
            29 - 31 Euston Road | King’s Cross{" "}
          </h1>
          <p className="text-graytext">
            Our comprehensive services are specifically designed to meet the
            unique needs of teams ranging from 40 to 100 individuals, ensuring
            fully managed office spaces. We handle all aspects of the process,
            freeing you to direct your full attention to your core business
            endeavors. Our commitment extends beyond office management. We're
            invested in nurturing a collaborative and conducive work atmosphere
            that reflects your brand's ethos and nurtures your team's
            productivity.
          </p>
        </div>
      </section>
