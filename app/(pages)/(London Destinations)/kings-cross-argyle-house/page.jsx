      ...
      <div className='overflow-hidden'>
        <div className='container relative m-auto'>
          <div className='flex xsm:flex-col lg:flex-row justify-between relative'>
            <div>
              <h1 className='text-white text-3xl font-bold'>29-31 Euston Road | King’s Cross</h1>
            </div>
            <div>
              <span className='text-white text-sm'>Euston Road | London</span>
            </div>
          </div>
          <div className='py-14'>
            <Carousel
            ...
            >
              <Image width={554} height={408} className='w-full pr-6' src={fortyseven} alt={fortyseven}/>
              <Image width={554} height={408} className='w-full pr-6' src={fortyeight} alt={fortyeight}/>
              <Image width={554} height={408} className='w-full pr-6' src={fortynine} alt={fortynine}/>
              <Image width={554} height={408} className='w-full pr-6' src={fifty} alt={fifty}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftyone} alt={fiftyone}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftytwo} alt={fiftytwo}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftythree} alt={fiftythree}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftyfour} alt={fiftyfour}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftyfive} alt={fiftyfive}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftysix} alt={fiftysix}/>
            </Carousel>
          </div>
        </div>
      </div>
