...
import { activationdeactivation, app, arrows, cleaningserv, coffeesoda, customize, cutlery, date, datee, daypass, dedicatedteam, eight, five, four, fullyequipped, fullyfurnished, guestrecep, hotdeskigheader, hotdesking, hotgirl, hundreds, itsupp, mail, maxx, mindspaceloc, monthlysub, nine, officespace, onboarding, one, orangedot, podaypass, podaypass2, podaypass3, podaypass4, ppboots, printing, registrationsystem, seven, showers, six, spiderman, ten, terrace, three, twenty, twentyfourseven, twentyone, twentytwo, two, ultrafast, weekly } from '@/images/images'
    ...
    <section className="lg:py-14 font-['Aventa'] relative">
      <div className=' container xsm:grid xsm:gap-y-8 xsm:grid-cols-1 xsm:grid-rows-1 lg:grid lg:grid-cols-2 lg:grid-rows-1'>
        <div className='flex flex-col justify-center items-start gap-6  xl:h-100 xsm:mt-10'>
          <h1 className='lg:text-5xl xsm:text-4xl font-bold'>Private office <br></br>Day Pass</h1>
          <p className='lg:text-lg xsm:text-lg font-medium'>On demand spaces </p>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex flex-row justify-start items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='lg:text-lg xsm:text-sm lg:w-ch21'>Book private offices for the day for your entire team </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch21'>Choose spaces across all of our locations </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
        ...
        <div className='xsm:relative sm:relative md:relative flex lg:absolute right-0 top-0 h-full lg:items-center md:items-center'>
          <Image className= 'lg:h-96 lg:w-960 xsm:w-full xsm:h-full xl:w-full xl:h-100' src={podaypass} alt={podaypass}/>
        </div>
      </div>
    </section>
    <section className='bg-white py-20'>
      ...
      <section className='lg:py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={podaypass2} alt={podaypass2}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Workspace space at your fingertips</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Innovative environment </h1>
                  <p className='text-graytext'>Get access to private offices,  hot desks, lounges, phone booths, and more—and enjoy high-speed Wi-Fi and unlimited coffee while you work.</p>
         ...
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            ...
            <div className="font-['Aventa'] flex flex-col justify-between">
               ...
               <div className='flex flex-col gap-4 items-start'>
                  ...
                  <p className='text-graytext'>From private offices, desks to  meeting rooms, high-speed Wi-Fi and printing services, we'll provide everything you need to help get more out of your working day.</p>
      ...
      <section className='lg:pt-20 lg:pb-40 xsm:pb-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={podaypass4} alt={podaypass4}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Meeting rooms to meet all your needs</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Get focused </h1>
                  <p className='text-graytext'>Book meeting rooms by the hour—from small rooms to large boardrooms. Filter by number of seats and amenities, such as TVs, video conferencing, and whiteboards.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
