...
function page() {
  ...
  return (
      ...
      <div className='overflow-hidden'>
        <div className='container relative m-auto'>
          <div className='flex xsm:flex-col lg:flex-row justify-between relative'>
            <div>
              <h1 className='text-white xsm:text-3xl lg:text-4xl font-bold'>Soho by Scope | Soho </h1>
              <span className='text-orange text-xl'>COMING SOON</span>
            </div>
          </div>
          <div className='py-14'>
            <Carousel
            ...
            >
              <Image width={554} height={408} className='w-full pr-6' src={seventy} alt={seventy}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventyone} alt={seventyone}/>
              <Image width={554} height={408} className='w-full pr-6' src={sevetytwo} alt={sevetytwo}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventythree} alt={seventythree}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventyfour} alt={seventyfour}/>
            </Carousel>
          </div>
        </div>
      </div>
        ...
        <div className='lg:grid lg:grid-cols-2 lg:grid-rows-1 gap-x-14'>
          <div className='flex flex-col gap-6'>
            ...
            <div className='grid grid-rows-1 grid-cols-2 gap-6 border border-gray p-0.1'>
              <div>
                <Image width={295} height={207} src={privateofficeindividual} alt={privateofficeindividual}/>
              </div>
              <div className='w-full flex flex-col gap-2 pr-4 py-4 justify-center'>
                <h1 className='font-bold text-2xl'>Private Office</h1>
                <p className='text-sm'>A private sanctuary tailored for businesses offering privacy.</p>
                <Link href='/solutions/private-office' className='text-center w-full py-4 border border-orange font-bold text-x'>
                  Find offices
                </Link>
              </div>
            </div>
            <div className='grid grid-rows-1 grid-cols-2 gap-6 border border-gray p-0.1'>
              <div>
                <Image width={295} height={207} src={fullfloorofficeindividual} alt={fullfloorofficeindividual}/>
              </div>
              <div className='w-full flex flex-col gap-2 pr-4 py-4 justify-center'>
                <h1 className='font-bold text-2xl'>Full Floor Office</h1>
                <p className='text-sm'>A self-contained workspace that offers privacy and exclusivity to larger teams or businesses</p>
                <Link href='/solutions/full-floor-office' className='text-center w-full py-4 border border-orange font-bold text-x'>
                  Find offices
                </Link>
              </div>
            </div>
            <div className='grid grid-rows-1 grid-cols-2 gap-6 border border-gray p-0.1'>
              <div>
                <Image width={295} height={207} src={individualdedicateddesk} alt={individualdedicateddesk}/>
              </div>
              <div className='w-full flex flex-col gap-2 pr-4 py-4 justify-center'>
                <h1 className='font-bold text-2xl'>Dedicated Desk</h1>
                <p className='text-sm'>A personalised and reserved workspace exclusively assigned to an individual or a team. </p>
                <Link href='/solutions/dedicated-desk' className='text-center w-full py-4 border border-orange font-bold text-x'>
                  Find offices
                </Link>
              </div>
            </div>
            <div className='grid grid-rows-1 grid-cols-2 gap-6 border border-gray p-0.1'>
              <div>
                <Image width={295} height={207} src={meetingroomindividual} alt={meetingroomindividual}/>
              </div>
              <div className='w-full flex flex-col gap-2 pr-4 py-4 justify-center'>
                <h1 className='font-bold text-2xl'>Meeting Room</h1>
                <p className='text-sm'>Well-equipped spaces that can be rented on-demand for professional meetings</p>
                <Link href='/solutions/meeting-room' className='text-center w-full py-4 border border-orange font-bold text-x'>
                  Find offices
                </Link>
              </div>
            </div>
          ...
          <form className='bg-pitch-black p-14'>
            <h1 className='text-white font-bold text-3xl mb-4'>Interested in this location?</h1>
            <p className='text-graytext'>Complete the form below to book a tour or connect with one of our team members to learn more.</p>
            <div className='flex flex-col gap-5 mt-5'>
              <div>
                <input type='text' placeholder="Name" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
              </div>
              <div>
                <input type='text' placeholder="Company name" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
              </div>
              <div>
                <input type='text' placeholder="Company name" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
              </div>
              <div>
                <input type='tel' placeholder="Phone number" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
              </div>
              <div>
                <input type='text' placeholder="Number of seats" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
              </div>
              <div className='relative focus:border-orange flex flex-row items-center'>
                <select className='py-5 border-b border-borderness focus:border-b focus:border-white arrow bg-transparent w-full text-flamingoorange font-bold text-xl text-graytext outline-none'>
                  <option selected disabled>Private office space</option>
              ...
              <div className='mt-5'>
                <h1 className='text-white font-bold text-2xl mb-2'>Would you like to book a tour?</h1>
                <div className='text-white font-base mb-4 mt-4 flex flex-row items-center gap-2'>
                  <input type='checkbox' className='tourcheckbox' required /><span className='font-thin'>Yes, schedule my tour</span>
                </div>
                <div className='text-white font-base mb-4 mt-4 flex flex-row items-center gap-2'>
                  <input type='checkbox' className='tourcheckbox' required /><span className='font-thin'>No, I would like to learn more first</span>
                </div>
                <button className='text-white font-bold bg-orange w-full py-4'>GET IN TOUCH</button>
                <p className='text-graytext mt-4'>By clicking the button below, you agree to our <br></br><Link href='/terms-of-services' className='text-orange underline'>Terms of Services</Link> and acknowledge our <Link href='/terms-of-services' className='text-orange underline'>Privacy Policy</Link></p>
              </div>
            </div>
          </form>
        </div>
    ...
    <section className="lg:py-20 xsm:py-10 font-['Aventa']">
      <div className='container'>
        <h1 className='font-bold text-3xl mb-4'>King’s Cross - Unique Office</h1>
        <p className='text-graytext'>Soho commands the heart of London's West End, serving as a prominent base for some of the world's largest companies. This dynamic district effortlessly harmonizes work, residential, and leisure elements, presenting an unparalleled destination that excels in both professional prowess and recreational charm. <br></br>We extend flexible workspace solutions tailored to accommodate teams spanning from 30 to 100 individuals. Our comprehensive management ensures that every aspect of these spaces is expertly overseen by our team. From setup to day-to-day operations, we take care of everything, allowing your team to focus exclusively on your core business activities.</p>
      </div>
    </section>
    <section className="lg:py-20 xsm:py-10 font-['Aventa']">
      <div className='container'>
        <div className='flex xsm:flex-col lg:flex-row justify-between'>
          ...
          <button className='border border-orange px-10 py-3 font-bold' onClick={toggle}>See All Amenities</button>
        </div>
        <div className='lg:grid lg:grid-cols-4 lg:grid-rows-2 xsm:flex xsm:flex-col gap-4 mt-10'>
          ...
          <div className='flex flex-col items-center py-6 gap-5 border border-gray'>
            <Image height={46} width={46} src={phonebooths} alt={phonebooths}/>
            <span className='font-bold text-xl'>Phone booths</span>
          </div>
          <div className='flex flex-col items-center py-6 gap-5 border border-gray'>
            <Image height={46} width={46} src={stockedkitchens} alt={stockedkitchens}/>
            <span className='font-bold text-xl'>Stocked kitchens</span>
          </div>
          <div className='flex flex-col items-center py-6 gap-5 border border-gray'>
            <Image height={46} width={46} src={meetingrooms} alt={meetingrooms}/>
    ...
    <section className="font-['Aventa'] lg:py-20 xsm:py-10">
      <div className='container'>
          ...
          <p className='text-graytext mb-6'>29-31 Euston Road | London | NW1 2SD</p>
          <Image width={1280} className='w-full' height={375} src={individualimage} alt={individualimage}/>
      </div>
    </section>
        ...
        >
          <Link href='/covent-garden'>
            <div className='relative mr-6'>
              <Image className='w-full' width={400} height={402} src={sixteen} alt={sixteen}/>
          ...
          <Link href='/soho'>
          <div className='relative mr-6'>
            <Image className='w-full' width={400} height={402} src={siho} alt={siho}/>
            <div className='absolute bg-yes bottom-0 left-0 right-0 p-6 flex flex-col items-start gap-3'>
          ...
          <Link href='/the-centrum'>
            <div className='relative mr-6'>
              <Image className='w-full' width={400} height={402} src={amsterdamcentrum} alt={amsterdamcentrum}/>
              <div className='absolute bg-yes bottom-0 left-0 right-0 p-6 flex flex-col items-start gap-3 '>
   ...
   <section className="font-['Aventa'] linear py-40 bg-pitch-black">
      <div className='container flex flex-col items-center'>
         <span className='text-orange font-normal text-2xl mb-4'>Get in touch</span>
         <h1 className='font-bold text-4xl text-white'>The next generation of workspace <br></br>for the next generation of talent </h1>
         <p className='text-center text-graytext mt-10'>To join the waiting list, please leave your details below. </p>
         <form className='w-full grid grid-cols-2 grid-rows-2 gap-10 mt-20'>
            <div>
               <input type='text' placeholder="First name" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
            </div>
            <div>
               <input type='text' placeholder="Last name" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
            </div>
            <div>
               <input type='tel' placeholder="Phone number" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
            </div>
            <div>
               <input type='email' placeholder="Email" className='arrow py-5 border-borderness border-b focus:border-b focus:border-white text-xl w-full text-flamingoorange font-bold outline-none bg-transparent'/>
            </div>
            <div className='col-start-1 col-end-3 flex flex-col items-center'>
               <button type='submit' className='text-white font-bold text-xl py-4 px-10 border-orange border'>JOIN THE WAITING LIST</button>
            </div>
         </form>
      </div>
   </section>
