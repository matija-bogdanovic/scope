                   ...
                   <div>
                     <div className="font['Aventa'] container grid grid-cols-2 grid-rows-1 w-full">
                       ...
                       >
                         ...
                         <h1 className="lg:text-2xl xsm:text-xl">
                           United Kingdom
                         </h1>
                       </div>
                       <div
               ...
               <div className="lg:flex xl:flex xl:flex-row xl:justify-between lg:justify-between lg:flex-row md:justify-between sm:justify-between xsm:justify-between md:flex xsm:flex sm:flex sm:flex-row xsm:flex-row md:flex-row lg:w-full">
                 ...
                 <ul className="lg:relative xsm:z-[12] xsm:right-0 lg:w-full lg:flex lg:flex-row lg:ml-10 xsm:left-0 xsm:ml-0 xsm:absolute lg:pt-0 xsm:py-8 xsm:bg-pitch-black xsm:w-full ml-8 xsm:flex lg:mt-0 gap-4 font-['Aventa'] text-sm text-center items-center xl:flex lg:py-8 lg:items-center lg:flex xsm:hidden xsm:flex-col sm:hidden w-full xsm:top-0 xsm:px-10 xsm:mt-14 lg:px-0 lg:py-0 lg:mt-0 lg:pb-0">
                   ...
                   <li className="relative h-full flex items-center justify-center">
                     <AnimatePresence>
                       <motion.div onHoverStart={() => setIsHovered(true)}>
                         <Link
                           className="xsm:hidden lg:block lg:font-bold lg:before:w-20 lg:before:top-0 xsm:font-bold lg:before:absolute lg:before:w-full before:h-2 before:bg-orange"
                           href="/locations"
                         >
                           Locations
                         </Link>
                   ...
                   <div className="xsm:mt-0 xsm:mt-2 xsm:w-full xsm:flex font-['Aventa'] xsm:flex-row gap-16 text-sm lg:justify-end xl:flex lg:flex xsm:flex xsm:flex-col lg:flex lg:flex-row ">
                     ...
                     <Link
                       href="/contact-us"
                       className="text-pitch-black px-36 py-3 bg-white"
                     >
                       Contact Us
                     </Link>
                   </div>
                 ...
                 <AnimatePresence>
                   {visible && (
                     <motion.ul
                       className="lg:relative xsm:z-[12] xsm:right-0 xsm:left-0 xsm:ml-0 xsm:absolute xsm:bg-pitch-black xsm:w-full xsm:flex font-['Aventa'] text-sm text-center xl:hidden xsm:flex-col w-full xsm:top-0 xsm:px-10 xsm:mt-14 xsm:items-center justify-center lg:hidden gap-7"
                     ...
                     >
                       ...
                       <li className="relative flex items-center justify-center">
                         ...
                         <Link
                           className="xsm:block lg:hidden lg:font-bold lg:before:w-20 lg:before:top-0 xsm:font-bold lg:before:absolute lg:before:w-full before:h-2 before:bg-orange"
                           href="/locations"
                         >
                           Locations
                         </Link>
