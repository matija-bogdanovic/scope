...
function page() {
  ...
  return (
      ...
      <div className='overflow-hidden'>
        <div className='container relative m-auto'>
          <div className='flex xsm:flex-col lg:flex-row justify-between relative'>
            <div>
              <h1 className='text-white text-3xl font-bold'>Slingsby Place | Covent Garden</h1>
            </div>
            <div>
              <span className='text-white text-sm'>11 Slingsby Place | London | WC2E 9AB </span>
            </div>
          </div>
          <div className='py-14'>
            <Carousel
            ...
            >
              <Image width={554} height={408} className='w-full pr-6' src={fiftyseven} alt={fiftyseven}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftyeight} alt={fiftyeight}/>
              <Image width={554} height={408} className='w-full pr-6' src={fiftynine} alt={fiftynine}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixty} alt={sixty}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtyone} alt={sixtyone}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtytwo} alt={sixtytwo}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtythree} alt={sixtythree}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtyfour} alt={sixtyfour}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtyfive} alt={sixtyfive}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtysix} alt={sixtysix}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtyseven} alt={sixtyseven}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtyeight} alt={sixtyeight}/>
              <Image width={554} height={408} className='w-full pr-6' src={sixtynine} alt={sixtynine}/>
            </Carousel>
          </div>
        </div>
      </div>
    ...
    <section className="lg:py-20 xsm:py-10 font-['Aventa']">
      <div className='container'>
        <h1 className='font-bold text-3xl mb-4'>29 - 31 Euston Road | King’s Cross </h1>
