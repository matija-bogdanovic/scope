  ...
  return (
    <>
      ...
      <section className='lg:py-20 xsm:py-10 bg-pitch-black'>
        <div className='container'>
          <div className='background-imagges lg:items-center xsm:items-start flex relative lg:h-680 xsm:h-50'>
            <div className="lg:flex lg:gap-4 vertical-text lg:absolute lg:text-orange lg:font-['Aventa'] xsm:flex xsm:gap-4 xsm:absolute xsm:text-orange xsm:font-['Aventa'] xsm:text-sm">SCROLL TO SEE MORE <Image src={longarrow} alt={longarrow}/></div>
            <div className='lg:ml-20 xsm:ml-10 text-white flex flex-col'>
              <h1 className="font-['Aventa'] font-semibold lg:text-8xl xsm:text-4xl sm:text-5xl md:text-6xl text-white sm:w-ch201 xsm:w-full">Empowering your work your way</h1>
              <p className="font-['Aventa'] font-normal mt-7 text-white">The next generation of flexible workspaces.<br></br> Global mindset local experience.</p>
            </div>
          </div>
          <div className='mt-20 lg:flex w-full items-center flex-col opacity-40 xsm:hidden'>
            <span className="text-white font-['Aventa']">Join the elite group of Scope clients</span>
            <div className='grid mt-8 grid-cols-5 grid-row-1 w-full'>
              ...
              <div className='flex items-center justify-center'>
                <Image width={161} height={33} alt={visaprint} src={visaprint}/>
              </div>
              <div className='flex items-center justify-center'>
          ...
          <div className='xsm:mt-10 lg:mt-20 xsm:flex lg:hidden w-full items-center flex-col opacity-40 overflow-hidden whitespace-nowrap'>
            ...
            <div className='logos-slide mt-8 xsm:flex xsm:flex-row '>
                <Image width={72} height={27} className='mr-6' alt={nike} src={nike}/>
                <Image width={123} height={27} className='mr-6' alt={easyjet} src={easyjet}/>
                <Image width={132} height={22} className='mr-6' alt={hisense} src={hisense}/>
                <Image width={161} height={33} className='mr-6' alt={visaprint} src={visaprint}/>
                <Image width={129} height={33} className='mr-6' alt={radix} src={radix}/>
                <Image width={72} height={27} className='mr-6' alt={nike} src={nike}/>
                <Image width={123} height={27} className='mr-6' alt={easyjet} src={easyjet}/>
                <Image width={132} height={22} className='mr-6' alt={hisense} src={hisense}/>
                <Image width={161} height={33} className='mr-6' alt={visaprint} src={visaprint}/>
        ...
        <div className='relative pb-12 gap-12 flex flex-col-reverse container overflow-hidden'>
          ...
          >
            <div className="relative text-white">
              <Image src={privateofficegirl} className='w-full' alt={privateofficegirl}/>
              <div className="linear-background font-['Aventa'] lg:p-9 xsm:p-7 flex justify-end gap-5 flex items-start flex-col">
                ...
                <Link href='/solutions/private-office' className='xsm:py-2 xsm:px-5 font-medium lg:py-5 lg:px-14 bg-white text-black'>See More</Link>
              </div>
            </div>
            <div className="ml-18 relative text-white h-full">
              ...
              <div className="linear-background font-['Aventa'] lg:p-9 xsm:p-7 flex justify-end gap-5 flex items-start flex-col">
                ...
                <Link href='/solutions/meeting-room' className='xsm:py-2 xsm:px-5 font-medium lg:py-5 lg:px-14 bg-white text-black'>See More</Link>
              </div>
            </div>
            <div className=" ml-18 h-full relative text-white">
              ...
              <div className="linear-background font-['Aventa'] lg:p-9 xsm:p-7 flex justify-end gap-5 flex items-start flex-col">
                ...
                <Link href='/solutions' className='xsm:py-2 xsm:px-5 font-medium lg:py-5 lg:px-14 bg-white text-black'>See More</Link>
              </div>
            </div>
            <div className="h-full ml-18 relative text-white">
              ...
              <div className="linear-background font-['Aventa'] lg:p-9 xsm:p-7 flex justify-end gap-5 flex items-start flex-col">
                ...
                <Link href='/solutions/dedicated-desk' className='xsm:py-2 xsm:px-5 font-medium lg:py-5 lg:px-14 bg-white text-black'>See More</Link>
              </div>
            </div>
          </Carousel>
        </div>
      ...
      <section className='lg:py-28 xsm:py-20'>
        <div className='container'>
          <h1 className="text-center font-bold text-4xl leading-10 font-['Aventa'] lg:w-ch27 m-auto">The next generation of workspace for the next generation of talent</h1>
        </div>
      </section>
      <section className='lg:py-28 xsm:pb-14'>
        <div className="font-['Aventa'] container gap-x-40 lg:grid lg:grid-cols-2 lg:grid-rows-1 xsm:grid xsm:grid-cols-1 xsm:grid-rows-2 xsm:gap-14">
          <div className='lg:gap-20 xsm:gap-10 flex flex-col'>
            ...
            <p className='text-center lg:w-ch22 m-auto'>Flexible memberships and turnkey offices that fit all budgets and hybrid strategies. Find space to focus and collaborate at scope locations.</p>
          </div>
          <div className='lg:gap-20 xsm:gap-10 flex flex-col'>
            <Image alt={second} src={second}/>
            <p className='text-center lg:w-ch22 m-auto'>Power your hybrid strategy, enhance employee experience and save on property costs by combining private office, coworking and flexible workspace solutions.</p>
          </div>
        </div>
      </section>
      <section className="font-['Aventa'] bg-pitch-black lg:py-20 xsm:py-14 text-white">
        <div className='container lg:grid lg:grid-cols-3 lg:gap-5 xsm:flex xsm:flex-col lg:grid-rows-1 w-full'>
          <h1 className='xsm:block lg:hidden col-start-1 col-end-4 text-center lg:mb-10 xsm:mb-8 font-bold text-3xl text-white'>Your workspace to engage your team and ideas</h1>
          <h1 className='xsm:hidden lg:block col-start-1 col-end-4 text-center lg:mb-10 xsm:mb-8 font-bold text-3xl text-white'>Your workspace to engage<br></br> your team and ideas</h1>
          <div className='lg:grid lg:grid-cols-1 lg:gap-6 xsm:gap-6 lg:grid-rows-2 xsm:flex xsm:flex-col mb-8'>
            ...
            <div>
              ...
              <p className='opacity-50 text-white'>Scope strategically selects Europe's most elite locations for its workspace solutions, ensuring a prestigious business address and unparalleled opportunities.</p>
            </div>
          </div>
          <div className='lg:grid lg:grid-cols-1 lg:gap-6 xsm:gap-6 lg:grid-rows-2 xsm:flex xsm:flex-col mb-8'>
            <div>
            ...
            <div>
              <h2 className='font-medium text-2xl mb-2'>Best in class service</h2>
              <p className='opacity-50 text-white'>Scope delivers unparalleled service through our best-in-class community managers, who prioritize and attend to all your needs, ensuring a seamless and exceptional workspace experience.</p>
            </div>
          </div>
          <div className='lg:grid lg:grid-cols-1 lg:gap-6 xsm:gap-6 lg:grid-rows-2 xsm:flex xsm:flex-col mb-'>
            <div>
              <Image className='xsm:w-full' alt={flexibility} src={flexibility}/>
            </div>
            <div>
              <h2 className='font-medium text-2xl mb-2'>Flexibility</h2>
              <p className='opacity-50 text-white'>Scope provides flexible workspace solutions that empower clients to easily upsize or downsize their workspace as needed, ensuring a tailored environment that caters to their specific requirements and allows for seamless adaptability.</p>
            </div>
          </div>
        </div>
      </section>
      <section className='lg:py-40 xsm:py-14'>
        <div className='container lg:grid lg:grid-cols-2 xsm:gap-y-6 lg:gap-0 xsm:flex xsm:flex-col lg:grid-rows-2 lg:gap-x-10'>
         ...
         <div className='xsm:hidden lg:block background-sfws col-start-2 col-end-3 row-start-1 row-end-3'>
         </div>
         <div className="font-['Aventa'] xsm:mb-6 lg:mb-0">
          <h1 className='font-bold text-3xl xsm:mb-5 lg:mb-8 lg:w-15ch xsm:w-15ch md:w-full'>Service first, workspace second</h1>
          <p className='xsm:mb-8 lg:mb-10'>At Scope, we take immense pride in delivering an exceptional level of service to our members. Alongside this, we offer a serious yet welcoming work environment through our membership amenities, ensuring that our members can thrive professionally while feeling valued, inspired, and supported.
          </p>
          <Link className=' bg-orange text-white lg:py-24 lg:px-14 xsm:py-4 xsm:px-8' href="/experience">
            Learn More
          </Link>
         </div>
         <div className='lg:h-full xsm:block xsm:h-90 md:h-100 lg:hidden background-sfws col-start-2 col-end-3 row-start-1 row-end-3'>
         </div>
        </div>
      </section>
      ...
      <section className='lg:py-28 xsm:py-8'>
        <div className="container font-['Aventa']">
          <h1 className="lg:text-3xl xsm:text-2xl font-['Aventa'] font-bold lg:mb-14 xsm:mb-7">Destinations in Europe</h1>
          <div className='grid grid-cols-2 grid-rows-1'>
            <div onClick={() => handleTabClick1('tab1')} className={isTabActive1('tab1') ? 'pb-4 border-b border-orange active cursor-auto ' : 'border-gray cursor-pointer border-b pb-4'}>
              <span className={isTabActive1('tab1') ? 'active cursor-auto text-orange text-sm ' : 'text-graytext text-sm'}>Netherlands</span>
              <h1 className='lg:text-2xl xsm:text-lg'>Amsterdam</h1>
            </div>
            <div onClick={() => handleTabClick1('tab2')} className={isTabActive1('tab2') ? 'pb-4 border-b border-orange active cursor-auto ' : 'border-gray cursor-pointer border-b pb-4'}>
              <span className={isTabActive1('tab2') ? 'active cursor-auto text-orange text-sm ' : 'text-graytext text-sm'}>United Kingdom</span>
            ...
            {isTabActive1('tab1') &&
              <div className='background-as flex flex-col lg:justify-end xsm:justify-start items-start lg:p-12 xsm:p-4'>
                <div className='bg-white py-6 px-6 xsm:w-full lg:w-490'>
                  ...
                  <p className="text-pich-black opacity-40 mt-4 w-ch48 xsm:w-full">Amsterdam has emerged as Europe's leading market for companies seeking to relocate and establish their presence.
                  </p>
                </div>
                <Link href="/the-centrum" className="flex flex-row lg:w-490 xsm:w-full mt-4 font-bold text-rl px-6 lg:py-5 xsm:py-4 justify-between text-pitch-black bg-white">
                  <span className='opacity-50'>Find out more</span> <Image alt={arrows} src={arrows}/>
                </Link>
              </div>
              }
              {isTabActive1('tab2') &&
                <div className='background-ld flex flex-col lg:justify-end xsm:justify-start items-start lg:p-12 xsm:p-4'>
                  <div className='bg-white p-6 xsm:w-full lg:w-490'>
                    ...
                    <p className="text-pich-black opacity-40 mt-4 w-ch48 xsm:w-full">London offers a dynamic and globally connected business environment, attracting companies for its strategic location, diverse talent pool, and extensive network of financial institutions.
                    </p>
                  </div>
                  <Link href="/covent-garden" className="flex flex-row lg:w-490 xsm:w-full mt-4 font-bold text-rl px-6 py-5 justify-between text-pitch-black bg-white">
                    Find out more <Image alt={arrows} src={arrows}/>
                  </Link>
                </div>
                }
      ...
      <section className="font-['Aventa'] lg:py-20 xsm:py-10">
        <div className='container'>
          <h1 className='text-center lg:text-3xl font-bold lg:mb-14 xsm:mb-7 xsm:text-2xl'>People of Scope</h1>
          <div className='overflow-hidden'>
            ...
            <div className='w-full pr-5 flex flex-col items-center'>
              ...
              <div className='w-full items-start flex flex-row ml-10'>
                <h1 className='mt-5 text-xl text-start'>CTO at series A startup</h1>
              </div>
            </div>
            <div className='w-full pr-5 flex flex-col items-center'>
              <Image className='ml-10' alt={founder} src={founder}/>
              <div className='w-full items-start flex flex-row ml-10'>
                <h1 className='mt-5 text-xl text-start'>Founder of food delivery app</h1>
              </div>
            </div>
            <div className='w-full flex pl-5 flex-col items-center'>
              <Image  alt={UI} src={UI}/>
              <div className='w-full items-start flex flex-row ml-10'>
                <h1 className='mt-5 text-xl text-start'>UI designer at FTSE 500</h1>
              </div>
            </div>
            </Carousel>
          </div>
      ...
      <section className='lg:py-28 xsm:py-20'>
        <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 xsm:hidden lg:gap-10'>
          ...
          <div className="font-['Aventa'] flex justify-between items-start flex-col">
            ...
            <p className=''>At Scope, our creative work environments played a crucial role in facilitating Sonantic's acquisition by Spotify for over $100 million by providing a conducive atmosphere that fosters innovation and collaboration. This achievement showcases the value of our workspaces in nurturing companies.</p>
            <Link href="/about" className='bg-orange text-white lg:py-4 lg:px-14 xsm:py-3 xsm:px-4'>Learn more</Link>
          </div>
        </div>
        <div className='container xsm:flex xsm:flex-col lg:hidden'>
          <div className="font-['Aventa'] flex justify-between items-start flex-col gap-5">
            <h1 className='font-bold lg:text-3xl xsm:text-2xl'>Success story</h1>
            <Image alt={spotify} src={spotify} className='w-full'/>
            <p className=''>At Scope, our creative work environments played a crucial role in facilitating Sonantic's acquisition by Spotify for over $100 million by providing a conducive atmosphere that fosters innovation and collaboration. This achievement showcases the value of our workspaces in nurturing companies.</p>
            <Link href="/about" className='bg-orange text-white py-4 px-14'>Learn more</Link>
          </div>
        </div>
      </section>
      ...
      <section className='xsm:py-10 lg:py-40'>
        <div className='container'>
          <h1 className="font-['Aventa'] lg:hidden xsm:block text-center font-bold lg:text-5xl xsm:text-2xl text-grayheading leading-11 lg:w-ch27 xsm:w-full m-auto">
            A community worth of your future Next generation workspaces <span className='text-pitch-black'>All managed by us</span>
          </h1>
          <h1 className="font-['Aventa'] lg:block xsm:hidden text-center font-bold lg:text-5xl xsm:text-2xl text-grayheading leading-11 lg:w-ch27 xsm:w-full m-auto">
            A community worth of your future Next generation workspaces <br></br><span className='text-pitch-black'>All managed by us</span>
          </h1>
        </div>
      </section>
      <section className='lg:py-20 xsm:py-10'>
        <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1'>
          ...
          <div className="font-['Aventa'] lg:flex lg:flex-row items-center gap-4 xsm:flex xsm:flex-col">
            <Link href="/landlords" className='bg-pitch-black text-white py-3 w-full text-center'>Landlord</Link>
            <Link href="/contact-us" className='bg-pitch-black text-white py-3 w-full text-center'>Broker</Link>
          </div>
        </div>
      </section>
      <Footer />
