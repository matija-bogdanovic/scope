      ...
      <div className='overflow-hidden'>
        <div className='container relative m-auto'>
          <div className='flex xsm:flex-col lg:flex-row justify-between relative'>
            <div>
              <h1 className='text-white xsm:text-3xl lg:text-4xl font-bold'>Amsterdam | Centrum </h1>
          ...
          <div className='py-14'>
            ...
            >
              <Image width={554} height={408} className='w-full pr-6' src={seventyfive} alt={seventyfive}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventysix} alt={seventyone}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventyseven} alt={seventyseven}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventyeight} alt={seventyeight}/>
              <Image width={554} height={408} className='w-full pr-6' src={seventynine} alt={seventynine}/>
              <Image width={554} height={408} className='w-full pr-6' src={eighty} alt={eighty}/>
              <Image width={554} height={408} className='w-full pr-6' src={eightyone} alt={eightyone}/>
            </Carousel>
          </div>
        </div>
      </div>
