...
import { activationdeactivation, app, arrows, cleaningserv, coffeesoda, customize, cutlery, date, datee, dedicated2, dedicateddesk, dedicatedteam, eight, five, fostercreativity, four, fullflooroffice, fullflooroffice2, fullflooroffice3, fullflooroffice4, fullyequipped, fullyfurnished, guestrecep, hundreds, itsupp, mail, mindspaceloc, monthlysub, nine, officespace, onboarding, one, orangedot, ppboots, printing, profy, registrationsystem, seven, showers, six, ten, terrace, three, twentyfourseven, two, ultrafast, weekly } from '@/images/images'
    ...
    <section className="lg:py-14 font-['Aventa'] relative">
      <div className=' container xsm:grid xsm:gap-y-8 xsm:grid-cols-1 xsm:grid-rows-1 lg:grid lg:grid-cols-2 lg:grid-rows-1'>
        <div className='flex flex-col justify-center items-start gap-6  xl:h-100 xsm:mt-10'>
          <h1 className='lg:text-5xl xsm:text-4xl font-bold'>Dedicated Desk</h1>
          <p className='lg:text-lg xsm:text-lg font-medium'>Monthly subscription - One location</p>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex flex-row justify-start items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='lg:text-lg xsm:text-sm lg:w-ch21'>Good for individuals and small teams</p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch21'>24/7 keycard access to your own desk in a shared office </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch40'>Turnkey space includes Wi-Fi, printing, coffee, on-site support, and more</p>
            </div>
        ...
        <div className='xsm:relative sm:relative md:relative flex lg:absolute right-0 top-0 h-full lg:items-center md:items-center'>
          <Image className= 'lg:h-96 lg:w-960 xsm:w-full xsm:h-full xl:w-full xl:h-100' src={dedicateddesk} alt={dedicateddesk}/>
        </div>
      </div>
    </section>
      ...
      <section className='lg:py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={dedicated2} alt={dedicated2}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>A home for your business or employees</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Your own space </h1>
                  <p className='text-graytext'>Get 24/7 access to your own desk in a shared office—ideal for a quieter, more private work setting—plus work from common areas such as phone booths and lounges.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      </section>
      <section className='xsm:py-10 lg:py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={fostercreativity} alt={fostercreativity}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>A productive workspace</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Foster creativity</h1>
                  <p className='text-graytext'>From your own lockable filing cabinet to bookable meeting rooms, high-speed Wi-Fi and printing services, we'll provide everything you need to help get more out of your working day.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      ...
      <section className='lg:pt-20 lg:pb-40 xsm:pb-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            ...
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>A home for your business</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Professional environment  </h1>
                  <p className='text-graytext'>Give your business its own address and enjoy the benefits of complimentary post and package handling.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
          ...
          <div className='lg:grid lg:grid-cols-3 lg:gap-5 lg:grid-rows-1 lg:mt-14 xsm:flex xsm:flex-col xsm:gap-10'>
            <div className='border border-gray p-0.1'>
              ...
              <div className='px-5 pb-5 flex flex-col justify-between'>
                ...
                <Link href='/solutions/full-floor-office' className='flex flex-row items-center justify-center font-bold text-white bg-orange w-full py-3'>
                  Find offices
                </Link>
              </div>
            </div>
