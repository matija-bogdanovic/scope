        ...
        <div className="overflow-hidden">
          <div className="container relative m-auto">
            <div className="flex xsm:flex-col lg:flex-row justify-between relative">
              <div>
                <h1 className="text-white xsm:text-3xl lg:text-4xl font-bold">
                  Soho by Scope | Soho{" "}
                </h1>
      ...
      <section className="lg:py-20 xsm:py-10 font-['Aventa']">
        <div className="container">
          <h1 className="font-bold text-3xl mb-4">
            King’s Cross - Unique Office
          </h1>
          <p className="text-graytext">
            Soho commands the heart of London's West End, serving as a prominent
            base for some of the world's largest companies. This dynamic
            district effortlessly harmonizes work, residential, and leisure
            elements, presenting an unparalleled destination that excels in both
            professional prowess and recreational charm. <br></br>We extend
            flexible workspace solutions tailored to accommodate teams spanning
            from 30 to 100 individuals. Our comprehensive management ensures
            that every aspect of these spaces is expertly overseen by our team.
            From setup to day-to-day operations, we take care of everything,
            allowing your team to focus exclusively on your core business
            activities.
          </p>
        </div>
      </section>
