...
export function Navwhiteusestate (props) {
   ...
   return (
      ...
      className="flex flex-center justify-center items-center xsm:hidden lg:block background-blur absolute bottom-0 top-0 left-0 right-0"
      onHoverEnd={() => setIsHovered(false)}
      >
      <motion.div
      className={"mt-35 font-['Aventa'] py-20 overflow-hidden lg:border-t lg:border-gray bg-white opacity-100 flex flex-row items-center justify-center z-[10]"}
      onHoverEnd={() => setIsHovered(false)}
            ...
            {isTabActive('tab1') && 
               ...
               >
                  <Link href='/kings-cross-argyle-house' className="border border-gray p-0.1 flex flex-col">
                     ...
                     <div>
                        <Image width={333} height={167} src={eleven} alt={eleven}/>
                     </div>
                  </Link>
                  <Link href='/covent-garden' className="border border-gray p-0.1 flex flex-col">
                     ...
                     <div>
                        <Image width={333} height={167} src={thirteen} alt={thirteen}/>
                     </div>
                  </Link>
                  <Link href='/soho' className="border border-gray p-0.1 flex flex-col">
                     ...
                     <div>
                        <Image width={333} height={167} src={fourteen} alt={fourteen}/>
                     </div>
                  </Link>
                  <Link href='/soho' className="border border-gray p-0.1 flex flex-col">
                     <div className="flex flex-col px-4 py-4 justify-center">
                     ...
                     <div>
                        <Image width={333} height={167} src={fifteen} alt={fifteen}/>
                     </div>
                  </Link>
               </div>
            }
            {isTabActive('tab2') && 
                  <div className="container">
                     <Link href='/the-centrum' className="border border-gray p-0.1 flex flex-col">
                        ...
                        <div>
                           <Image height={167} width={1280} src={twelve} alt={twelve}/>
                        </div>
                     </Link>
                  </div>
               }
      ...
      <nav className='relative xsm:z-[10] w-full bg-white lg:py-0 text-pitch-black xsm:items-center xsm:flex xsm:flex-row xsm:py-6 sm:items-center sm:flex sm:flex-row'>
         <div className='container'>
            ...
            <Link href='/' className={`link ${pathname === '/' ? 'active flex items-center justify-center' : ''}`} legacyBehavior>
               <Image className="cursor-pointer" src={whitelogo} alt={whitelogo} loading='lazy' objectPosition='center' w={91}/>
            </Link>
            <svg onClick={toggle} className={visible ? "hidden" : "cursor-pointer lg:hidden md:block sm:block xsm:blck"} xmlns="http://www.w3.org/2000/svg" width="32" height="30" viewBox="0 0 32 30" fill="none">
               <path fill-rule="evenodd" clip-rule="evenodd" d="M32 4.25L-3.29121e-07 4.25L0 0.25L32 0.250003L32 4.25Z" fill="black"/>
               <path fill-rule="evenodd" clip-rule="evenodd" d="M32 17L-3.03804e-07 17L0 13L32 13L32 17Z" fill="black"/>
               <path fill-rule="evenodd" clip-rule="evenodd" d="M32.0001 29.75L13.7144 29.75L13.7144 25.75L32.0001 25.75L32.0001 29.75Z" fill="black"/>
            </svg>
               ...
               <ul className={visible ? "lg:relative xsm:z-[12] xsm:right-0 lg:w-full lg:flex lg:flex-row lg:ml-10 xsm:left-0 xsm:ml-0 xsm:absolute lg:pt-0 xsm:py-8 xsm:bg-white xsm:w-full ml-8 xsm:flex lg:mt-0 flex gap-4 font-['Aventa'] text-sm text-center items-center xl:flex lg:py-8 lg:items-center lg:flex xsm:flex xsm:flex-col sm:flex w-full xsm:top-0 xsm:px-10 xsm:mt-14" : "lg:bg-transparent lg:w-full lg:relative ml-8 flex gap-4 font-['Aventa'] text-sm text-center items-center xl:flex lg:flex xsm:hidden sm:hidden"}>
                  ...
                  <li className="relative h-full flex items-center justify-center">
                     <AnimatePresence>
                        ...
                        >
                           <Link 
                              className={`link ${pathname === '/locations' ? 'lg:font-bold lg:before:w-20 lg:before:top-0 xsm:font-bold lg:before:absolute lg:before:w-full before:h-2 before:bg-orange' : ''}`}
                              href="/locations"
                           >
                              Locations
                           </Link>
                  ...
                  <div className="xsm:mt-0 xsm:mt-2 xsm:w-full xsm:flex font-['Aventa'] xsm:flex-row gap-16 text-sm lg:justify-end xl:flex lg:flex xsm:flex xsm:flex-col lg:flex lg:flex-row ">
                     ...
                     <Link href='/contact-us' className='text-white px-36 py-3 bg-pitch-black'>Contact Us</Link>
                  </div>
               </ul>
            </div>
         </div>
