...
import { activationdeactivation, app, arrows, cleaningserv, coffeesoda, customize, cutlery, date, datee, dedicatedteam, eight, five, four, fullyequipped, fullyfurnished, guestrecep, hundreds, itsupp, mail, mindspaceloc, monthlysub, nine, officespace, onboarding, one, orangedot, ppboots, printing, registrationsystem, seven, showers, six, ten, terrace, three, twentyfourseven, two, ultrafast, weekly } from '@/images/images'
    ...
    <section className="lg:py-14 font-['Aventa'] relative">
      <div className=' container xsm:grid xsm:gap-y-8 xsm:grid-cols-1 xsm:grid-rows-1 lg:grid lg:grid-cols-2 lg:grid-rows-1'>
        <div className='flex flex-col justify-center items-start gap-6  xl:h-100 xsm:mt-10'>
          <h1 className='lg:text-5xl xsm:text-4xl font-bold'>Private office</h1>
          <p className='lg:text-lg xsm:text-lg font-medium'>Monthly or annual membership -<br></br>Flexible commitment terms</p>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex flex-row justify-start items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='lg:text-lg xsm:text-sm lg:w-ch21'>Turnkey, furnished private workspace for teams of 1–100+</p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch21'>Layouts can include dedicated meeting rooms and executive offices</p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch23'>Enjoy fast Wi-Fi, unlimited coffee, on-site team, and more.</p>
            </div>
        ...
        <div className='xsm:relative sm:relative md:relative flex lg:absolute right-0 top-0 h-full lg:items-center md:items-center'>
          <Image className= 'lg:h-96 lg:w-960 xsm:w-full xsm:h-full xl:w-full xl:h-100' src={officespace} alt={officespace}/>
        </div>
      </div>
    </section>
      ...
      <section className='lg:py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            ...
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>A range of options to fit<br></br> your team’s needs</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Fully equipped</h1>
                  <p className='text-graytext'>Enjoy fully furnished, lockable offices with optional private amenities like interior rooms for executive offices or meetings, lounges, pantries, and more. Plus, get access to the building’s shared professional amenities.</p>
      ...
      <section className='py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            ...
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Move-in ready</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Get to work </h1>
                  <p className='text-graytext'>Our locations offer workspace where and how you need it, with high-speed Wi-Fi, cleaning services, and the ability to select from various furniture layouts. Make the space your own with add-ons, such as increased privacy and branding.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      ...
      <section className='lg:pt-20 lg:pb-40 xsm:pb-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            ...
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Flexible commitments </h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Up-size or down-size </h1>
                  <p className='text-graytext'>Get up and running from day one in a fully furnished office with a monthly or annual commitment. As your priorities shift, our locations enables you to scale up or down to meet your business’s evolving needs.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
