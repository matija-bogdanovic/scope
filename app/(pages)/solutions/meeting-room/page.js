...
import { activationdeactivation, app, arrows, cleaningserv, coffeesoda, customize, cutlery, date, datee, dedicatedteam, eight, five, four, fullflooroffice4, fullyequipped, fullyfurnished, guestrecep, hotdeskigheader, hotdesking, hotgirl, hundreds, itsupp, mail, maxx, mindspaceloc, monthlysub, nine, officespace, onboarding, one, orangedot, ppboots, printing, registrationsystem, seven, showers, six, spiderman, ten, terrace, three, twentyfive, twentyfour, twentyfourseven, twentysix, twentythree, two, ultrafast, weekly } from '@/images/images'
    ...
    <section className="lg:py-14 font-['Aventa'] relative">
      <div className=' container xsm:grid xsm:gap-y-8 xsm:grid-cols-1 xsm:grid-rows-1 lg:grid lg:grid-cols-2 lg:grid-rows-1'>
        <div className='flex flex-col justify-center items-start gap-6  xl:h-100 xsm:mt-10'>
          <h1 className='lg:text-5xl xsm:text-4xl font-bold'>Meeting Room</h1>
          <p className='lg:text-lg xsm:text-lg font-medium'>Tailored solutions for your team </p>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex flex-row justify-start items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='lg:text-lg xsm:text-sm lg:w-ch21'>Good for small and large groups. </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch21'>High speed internet and conference A/V tools. </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch23'>Enjoy shared amenities and business essentials</p>
            </div>
            <Link href='/contact-us' className='text-white bg-pitch-black py-4 px-8'>Get a quote</Link>
          </div>
        </div>
        <div className='xsm:relative sm:relative md:relative flex lg:absolute right-0 top-0 h-full lg:items-center md:items-center'>
          <Image className= 'lg:h-96 lg:w-960 xsm:w-full xsm:h-full xl:w-full xl:h-100' src={twentythree} alt={twentythree}/>
        </div>
      </div>
    </section>
    <section className='bg-white py-20'>
      ...
      <section className='lg:py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={twentyfour} alt={twentyfour}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Book meeting rooms to meet your needs </h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Collaboration and focus</h1>
                  <p className='text-graytext'>From small rooms to large meeting spaces, we have meeting rooms in all shapes and sizes. Benefit from our amenities such as TVs, phones, whiteboards and video conferencing and more.</p>
      ...
      <section className='py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={twentyfive} alt={twentyfive}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Designed to support productivity</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Everything you need </h1>
                  <p className='text-graytext'>Take on the working day and be more productive in spaces that offer high-speed Internet, business-class printers and conferencing A/V tools. Our assortment of meeting rooms will help set you up for success and give you space you need to get things done.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      ...
      <section className='lg:pt-20 lg:pb-40 xsm:pb-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={twentysix} alt={twentysix}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>On-site support team</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>People for people </h1>
                  <p className='text-graytext'>Our Community Teams are on the ground to help ensure your event needs are met in real time.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      ...
      <section className="font-['Aventa'] lg:py-28 xsm:py-8">
        <div className='container'>
          ...
          <div className='lg:grid lg:grid-cols-3 lg:gap-5 lg:grid-rows-1 lg:mt-14 xsm:flex xsm:flex-col xsm:gap-10'>
            ...
            <div className='border border-gray p-0.1'>
              <Image src={fullflooroffice4} alt={fullflooroffice4}/>
              <div className='px-5 pb-5 flex flex-col justify-between'>
                <div className='border-b border-gray pb-10 mt-6'>
                  <h1 className='lg:text-3xl xsm:text-2xl font-bold mb-2'>Private Office</h1>
                  <p className='opacity-50'>Private, turnkey & furnished flexible workspaces</p>
                </div>
                <div className='border-b border-gray pb-8 mt-6'>
                  <h1 className='opacity-50 mb-1'>Membership type</h1>
                  <p className='text-lg'>Monthly or Annual subscription</p>
                </div>
                <div className='border-b border-gray pb-8 mt-6'>
                  <h1 className='opacity-50 mb-1'>Ideal team size</h1>
                  <p className='text-lg'>1 - 100 people</p>
                </div>
                <div className='border-b border-gray pb-8 mt-6'>
                  <h1 className='opacity-50 mb-1'>Hours of access</h1>
                  <p className='text-lg'>24/7</p>
                ...
                <Link href='/solutions/private-office' type='button' className='justify-center items-center flex font-bold bg-transparent border border-orange w-full py-3'>
                  Learn more
                </Link>
              </div>
            </div>
