...
import { activationdeactivation, app, arrows, cleaningserv, coffeesoda, customize, cutlery, date, datee, dedicatedteam, eight, five, four, fullflooroffice, fullflooroffice2, fullflooroffice3, fullflooroffice4, fullyequipped, fullyfurnished, guestrecep, hundreds, itsupp, mail, mindspaceloc, monthlysub, nine, officespace, onboarding, one, orangedot, ppboots, printing, registrationsystem, seven, showers, six, ten, terrace, three, twentyfourseven, two, ultrafast, weekly } from '@/images/images'
    ...
    <section className="lg:py-14 font-['Aventa'] relative">
      <div className=' container xsm:grid xsm:gap-y-8 xsm:grid-cols-1 xsm:grid-rows-1 lg:grid lg:grid-cols-2 lg:grid-rows-1'>
        <div className='flex flex-col justify-center items-start gap-6  xl:h-100 xsm:mt-10'>
          <h1 className='lg:text-5xl xsm:text-4xl font-bold'>Full Floor Office</h1>
          <p className='lg:text-lg xsm:text-lg font-medium'>Annual membership - Flexible<br></br> commitment terms</p>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex flex-row justify-start items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='lg:text-lg xsm:text-sm lg:w-ch21'>Suitable for 50 or more people </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch21'>Fully furnished office on a private floor </p>
            </div>
            <div className='flex flex-row items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='xsm:text-sm lg:text-lg lg:w-ch23'>Enjoy private amenities and options for personal branding </p>
            </div>
        ...
        <div className='xsm:relative sm:relative md:relative flex lg:absolute right-0 top-0 h-full lg:items-center md:items-center'>
          <Image className= 'lg:h-96 lg:w-960 xsm:w-full xsm:h-full xl:w-full xl:h-100' src={fullflooroffice} alt={fullflooroffice}/>
        </div>
      </div>
    </section>
      ...
      <section className='lg:py-20 xsm:py-10'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={fullflooroffice2} alt={fullflooroffice2}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>A private floor for your team to spread out and grow</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Growth</h1>
                  <p className='text-graytext'>Enjoy a dedicated office floor with your own private amenities such as a branded reception, meeting rooms, executive offices, phone booths, pantries, and more.</p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      </section>
      <section className='py-20 xsm:py-10'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={two} alt={two}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Personalise your space to meet your team’s needs</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Bespoke spaces </h1>
                  <p className='text-graytext'>Select from a variety of layouts to fit your team’s work style. Plus, choose from add-ons including furniture, accessories, branding, finishes, and more. </p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      ...
      <section className='lg:pt-20 lg:pb-40 xsm:pb-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={fullflooroffice3} alt={fullflooroffice3}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               <h1 className='lg:font-bold lg:text-5xl lg:text-grayheading xsm:font-bold xsm:text-3xl xsm:text-grayheading'>Enterprise-level space enhancements</h1>
               <div className='flex flex-col gap-4 items-start'>
                  <h1 className='lg:font-bold lg:text-3xl xsm:text-2xl xsm:mt-8 xsm:font-bold'>Built for purpose </h1>
                  <p className='text-graytext'>Our professionally deployed technology solutions enhance network performance, speed, and security—all complemented by our booking software that helps members manage their workspace. </p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
