...
import { activationdeactivation, app, arrows, cleaningserv, coffeesoda, customize, cutlery, date, datee, daypass, dedicatedteam, eight, five, four, fullyequipped, fullyfurnished, guestrecep, hotdeskigheader, hotdesking, hotgirl, hundreds, itsupp, mail, maxx, mindspaceloc, monthlysub, nine, officespace, onboarding, one, orangedot, ppboots, printing, registrationsystem, seven, showers, six, spiderman, ten, terrace, three, twenty, twentyfourseven, twentyone, twentytwo, two, ultrafast, weekly } from '@/images/images'
   ...
   <div onClick={toggle} className={isClicked ? 'background-blur flex flex-col xsm:px-10 items-center justify-center fixed top-0 left-0 right-0 bottom-0 z-[1000]' : 'hidden'}>
    ...
    <section className="lg:py-14 font-['Aventa'] relative">
      <div className=' container xsm:grid xsm:gap-y-8 xsm:grid-cols-1 xsm:grid-rows-1 lg:grid lg:grid-cols-2 lg:grid-rows-1'>
        <div className='flex flex-col justify-center items-start gap-6  xl:h-100 xsm:mt-10'>
          <h1 className='lg:text-5xl xsm:text-4xl font-bold'>Day Pass </h1>
          <p className='lg:text-lg xsm:text-lg font-medium'>On demand spaces </p>
          <div className='flex flex-col gap-8 items-start'>
            <div className='flex flex-row justify-start items-start gap-4'>
              <Image src={orangedot} alt={orangedot}/>
              <p className='lg:text-lg xsm:text-sm lg:w-ch21'>Book our co-working spaces and lounge areas for the day </p>
            </div>
        ...
        <div className='xsm:relative sm:relative md:relative flex lg:absolute right-0 top-0 h-full lg:items-center md:items-center'>
          <Image className= 'lg:h-96 lg:w-960 xsm:w-full xsm:h-full xl:w-full xl:h-100' src={daypass} alt={daypass}/>
        </div>
      </div>
    </section>
    <section className='bg-white py-20'>
         ...
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            ...
            <div className="font-['Aventa'] flex flex-col justify-between">
               ...
               <div className='flex flex-col gap-4 items-start'>
                  ...
                  <p className='text-graytext'>Get access to hot desks, lounges, phone booths, and more—and enjoy high-speed Wi-Fi and unlimited coffee while you work.</p>
      ...
      <section className='py-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={twentytwo} alt={twentytwo}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
               ...
               <div className='flex flex-col gap-4 items-start'>
                  ...
                  <p className='text-graytext'>From desks to  meeting rooms, high-speed Wi-Fi and printing services, we'll provide everything you need to help get more out of your working day. </p>
                  <Link className='border border-orange py-3 px-14 font-bold' href='/contact-us'>Learn more</Link>
               </div>
            </div>
         </div>
      ...
      <section className='lg:pt-20 lg:pb-40 xsm:pb-20'>
         <div className='container lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-20 xsm:flex xsm:flex-col xsm:gap-8'>
            <div>
               <Image src={twentyone} alt={twentyone}/>
            </div>
            <div className="font-['Aventa'] flex flex-col justify-between">
